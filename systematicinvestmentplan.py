...
class SIPForm(FlaskForm):
    ...
    expectedReturnRate = FloatField('Expected Return Rate', validators=[DataRequired('Expected Return Rate is required'), NumberRange(min=0,max=100,message='Invalid Expected Return Rate')])
